...
<%@ page import="org.javarush.karpiza.model.RequestParamType" %>
<jsp:useBean id="sessionState" scope="session" type="org.javarush.karpiza.model.SessionState"/>
<html>
<head>
    <title>Игра</title>
...
<div id="all-page" class="container w-50 position-relative">
    ...
    <c:if test="${sessionState.currentGameNode.win}">
        <p><img id="win-img" src="static/img/excellent-perfect.gif"></p>
    </c:if>
